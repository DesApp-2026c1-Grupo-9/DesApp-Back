...
3. **Consistencia:** Asegúrate de que los modelos de Sequelize creados por un agente coincidan con las necesidades de los controladores de otro.
4. **Validación:** El backend siempre debe validar las reglas de negocio (ej. tamaño de archivos de 25MB) independientemente de las validaciones del frontend.
