...
export default class Sesion extends Model {
    ...
    return super.init(
      {
        ...
        tipo: { type: DataTypes.ENUM('virtual', 'presencial'), allowNull: false },
  ...
  static associate(db) {
    ...
    Sesion.belongsTo(db.Usuario, { foreignKey: 'creadorId', as: 'creador' });
    Sesion.hasMany(db.SesionParticipante, { foreignKey: 'sesionId', as: 'participantes' });
  }
}
