...
router.put(
  '/:id/participantes/:participanteId/aprobar',
  withErrorHandling(aprobarParticipante)
);
router.put(
  '/:id/participantes/:participanteId/rechazar',
  withErrorHandling(rechazarParticipante)
);
router.delete(
  '/:id/participantes/:participanteId',
  withErrorHandling(leaveSesion)
);
