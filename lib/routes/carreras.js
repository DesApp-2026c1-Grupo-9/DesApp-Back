...
router.get('/:id/materias', withErrorHandling(getMateriasAsignadas));
router.post('/:id/materias', withErrorHandling(asignarMaterias));
router.delete('/:id/materias/:materiaId', withErrorHandling(desasignarMateria));
...
router.get(
  ...
  withErrorHandling(getMateriasByPlan)
);
router.post(
  '/:carreraId/planes/:planId/materias',
